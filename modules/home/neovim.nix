...

{
  programs.neovim = {
    ...
    initLua = ''
        ...
        map("n", "<C-z>", "u", "Undo")
        map("n", "<C-y>", "<C-r>", "Redo")
        map("n", "<C-e>", ":Neotree toggle<CR>", "Toggle tree")
        ...
        map("n", "<C-Tab>",   "<cmd>BufferLineCycleNext<CR>", "Next buffer")
        map("n", "<C-S-Tab>", "<cmd>BufferLineCyclePrev<CR>", "Prev buffer")

        map("i", "<C-a>", "<Esc>ggVG", "Select all")
        map("i", "<C-c>", "<Esc>v\"+y", "Copy")
        map("i", "<C-x>", "<Esc>v\"+x", "Cut")
        map("i", "<C-v>", "<C-r>+", "Paste")
        map("i", "<C-z>", "<Esc>u", "Undo")
        map("i", "<C-y>", "<Esc><C-r>", "Redo")
        map("i", "<C-e>", "<Esc>:Neotree toggle<CR>", "Toggle tree")
        map("i", "<C-q>", "<Esc>:Alpha<CR>", "Dashboard")
        map("i", "<C-s>", "<Esc>:w<CR>", "Save file")
        map("i", "<C-Tab>",   "<cmd>BufferLineCycleNext<CR>", "Next buffer")
        map("i", "<C-S-Tab>", "<cmd>BufferLineCyclePrev<CR>", "Prev buffer")
        ...
        options = {
          ...
          color_icons = true,
          diagnostics = "nvim_lsp",  -- mostra errori LSP sulle tab
